  ...
  return [
    {
      ...
      layout: "hero",
      label: en("MONITOR"),
      headline: en("See every local dev\nserver on your Mac."),
      screenshot: "/screenshots/apple/mac/en/01.jpg",
    },
    {
      id: nid(),
      layout: "split-landscape",
      label: en("CONTROL"),
      headline: en("Open, copy, or kill\nports in one click."),
      screenshot: "/screenshots/apple/mac/en/02.jpg",
    },
    {
      id: nid(),
      layout: "split-landscape",
      label: en("DOCKER"),
      headline: en("Inspect container names\nand process PIDs."),
      screenshot: "/screenshots/apple/mac/en/03.png",
    },
    {
      id: nid(),
      layout: "split-landscape",
      label: en("HEALTH"),
      headline: en("Probe HTTP endpoints\nwith active status dots."),
      screenshot: "/screenshots/apple/mac/en/04.png",
    },
  ];
}
...
export function detectPlatform(device: Device): "ios" | "android" {
  return device === "iphone" || device === "ipad" || device === "mac" ? "ios" : "android";
}
